...
{
    public enum SupportDay// am zis ca e mai bine sa avem un enum, pt ca se presupune ca stiu ca exista 2 sift-uri si nu are rost sa complic situatia cu DateTime
    {
